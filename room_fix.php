...
<head>
    ...
    <link rel="stylesheet" href="css/videocall/room_fix.css">
...
<body data-rank="<?php echo htmlspecialchars($current_user_info['rank']); ?>">
    ...
    <div id="version-indicator" title="Last updated: <?php echo date('Y-m-d H:i:s T', strtotime('now')); ?> (Thailand time)">v1.0.0</div>
</body>
</html>
